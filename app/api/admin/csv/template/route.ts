...
const TEMPLATE_CONFIG: Record<string, { headers: string[]; samples: string[][] }> = {
  ...
  maintenance_records: {
    ...
    samples: [
      ['1', '202512', '12가3456', '그랜저', '15000', '엔진오일', '2025-12-05', '2025-12-05', '기본정비', 'SK네트웍스', '완료', '85000', '엔진오일 교체'],
      ['1', '202512', '78나9012', '아반떼', '12000', '타이어', '2025-12-10', '2025-12-10', '타이어교체', 'T-Station', '완료', '240000', '앞바퀴 2본 교체'],
    ],
  },
  accidents: {
    headers: [
    ...
    samples: [
      ['1', '202512', '영업부', '홍길동', '12가3456', '그랜저', '대물', '차대차', '2025-12-15 14:30:00', '서울 용산구', '2025-12-15', 'ACC-2025-001', '종결', '2025-12-20', '300000', '1500000', '측면 충돌 사고'],
    ],
  },
  violations: {
    headers: [
    ...
    samples: [
      ['1', '202512', '영업부', '홍길동', '12가3456', '2025-12-10 10:20:00', '과태료납부통지서', '60000', '속도위반', '경찰청', '서울 종로구', '2026-01-10', 'false', '', 'true', '2025-12-28', '0', '속도위반', ''],
    ],
  },
  companies: {
